...
class MeshEvaluator:
    ...
    @staticmethod
    def init_gl():
        from util.render.gl.glcontext import create_opengl_context
        from util.render.gl.NormalRender import NormalRender
        create_opengl_context(width=512, height=512)
    ...
    def _render_normal(self, mesh, deg):
        ...
        view_mat[2, 2] *= -1
        self._normal_render.set_attrib(0, self.scale_factor*mesh.vertices[mesh.faces.flatten(), :])
        self._normal_render.set_attrib(1, mesh.vertex_normals[mesh.faces.flatten(), :])
...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--root', type=str, default='/home/shunsukesaito/Downloads/results')
    parser.add_argument('-t', '--tar_path', type=str, default='/home/shunsukesaito/Documents/eval_kit/eval_dataset')
    ...
    exp_list = [    
               'mr_test_ablation_fixed_ours_hg',
               'mr_test_ablation_fixed_wnml_ours_hg',
               'mr_test_ablation_hg_resnet0',
               'mr_test_ablation_hg_resnet1',
               'mr_fullbody_no_nml_hg_fp0_1112',
               'mr_test_ablation_fulltrain_ours_hg',
               'cluster_fullbody_center_1025_img.hg.group.4.2.256_wbg1_s3.20',
               'mr_test_fullres_ablation_hg_resnet0',
               'mr_test_fullres_ablation_hg_resnet1']
