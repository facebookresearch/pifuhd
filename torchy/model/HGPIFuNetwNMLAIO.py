...
class HGPIFuNetwNMLAIO(BasePIFuNet):
    '''
    ...
    def __init__(self, 
        ...
        super(HGPIFuNetwNMLAIO, self).__init__(
        ...
        self.netFB = define_G(3, 9, 64, "global", 4, 9, 1, 3, "instance")
    ...
    def filter(self, images):
        ...
        with torch.no_grad():
            out = self.netFB.forward(images).detach()
            self.nmlB = out[:,:3,:,:]
            self.nmlF = out[:,3:6,:,:]
            self.clrB = out[:,6:,:,:]
